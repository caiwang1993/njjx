...
import blueSmall1 from '../../assets/blue_small1.jpg';
import blueSmall2 from '../../assets/blue_small2.jpg';
    ...
    return(
      <div className={styles.lifecycleBox}>
        <QueueAnim type={['top', 'bottom']} delay="600">
          <div className={styles.blue} key="d" onClick={this.jumpToAIproduction}>
            <img src={yellow} alt=""/>
        ...
        <QueueAnim type={['bottom', 'top']} delay="800">
          <div className={styles.purple} key="c" onClick={this.jumpToAIdesign}>
            <img src={green} alt=""/>
        ...
        <QueueAnim type={['bottom', 'top']} delay="450">
          <div className={styles.yellow} key="b" onClick={this.jumpToAIexperiment}>
            <img src={blue} alt=""/>
        ...
        <QueueAnim type={['top', 'bottom']}>
          <div className={styles.green} key="a" onClick={this.jumpToAImonitor}>
            <img src={purple} alt=""/>
