...
export default class Carousel3d extends PureComponent {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (
      ...
      React.Children.toArray(children).length !== React.Children.toArray(this.props.children).length
    ) {
  ...
  getChildrenToRender = children => {
    ...
    return newChildren.map((item, i) => {
      ...
      return (
        <div className={styles.itemWrapper} key={item.key} style={style}>
          <div
          ...
          >
            <div className={styles.bgAndBlurLayer} style={{ ...animStyle }}>
